      ...
      <div className="flex flex-wrap">
        {posts.map((post) => {
          return (
            <article
              key={post.id}
              className="flex-none  bg-[#efefef] rounded text-[#4a4a4a] p-6 m-4 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]"
            >
              <Image
                className="rounded"
